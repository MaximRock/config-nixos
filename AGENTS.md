...
Not lazy about: understanding the problem, input validation at trust boundaries, error handling that prevents data loss, security, accessibility, calibration real hardware needs, anything explicitly requested. Non-trivial logic leaves ONE runnable check behind (an assert-based demo/self-check or one small test file; no frameworks, no fixtures).

Full reference: https://github.com/DietrichGebert/ponytail
<!-- ponytail:end -->
